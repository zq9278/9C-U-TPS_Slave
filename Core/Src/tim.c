...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM14_MspPostInit 0 */
    ...
    PA4     ------> TIM14_CH1
    */
    GPIO_InitStruct.Pin = Heat1_PWM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF4_TIM14;
    HAL_GPIO_Init(Heat1_PWM_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM15_MspPostInit 0 */
    ...
    */
    ...
    GPIO_InitStruct.Pin = AirPump1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF5_TIM15;
    HAL_GPIO_Init(AirPump1_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM17_MspPostInit 0 */
    ...
    PA7     ------> TIM17_CH1
    */
    GPIO_InitStruct.Pin = Heat2_PWM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF5_TIM17;
    HAL_GPIO_Init(Heat2_PWM_GPIO_Port, &GPIO_InitStruct);
